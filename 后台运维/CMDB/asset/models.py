...
class Asset(models.Model):
    ...
    name = models.CharField(max_length=64, unique=True)  # 资产名
    sn = models.CharField(u'资产SN号', max_length=128, unique=True)  # SN序列号
    manufactory = models.ForeignKey('Manufactory', verbose_name=u'制造商', null=True, blank=True)  # 制造商
    ...
    trade_date = models.DateField(u'购买时间', null=True, blank=True)  # 购买日期
    expire_date = models.DateField(u'过保修期', null=True, blank=True)  # 过保日期
    price = models.FloatField(u'价格', null=True, blank=True)  # 价格
    business_unit = models.ForeignKey('BusinessUnit', verbose_name=u'所属业务线', null=True, blank=True)
    tags = models.ManyToManyField('Tag', blank=True)
    admin = models.ForeignKey('UserProfile', verbose_name=u'资产管理员', null=True, blank=True)  # 资产管理员
    idc = models.ForeignKey('IDC', verbose_name=u'IDC机房', null=True, blank=True)  # IDC机房
...
class Server(models.Model):
    asset = models.OneToOneField('Asset')  # 与Asset做一对一关联
